...
## setSuppressWarnings
`setSuppressWarnings(warningIds: string[])`

Set the global warning suppressions. Defaults to an empty array.

See the [warning page](/config/warnings) for a list of all IDs and means of setting suppression.
