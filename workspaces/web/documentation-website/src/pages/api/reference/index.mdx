...
import { ApiTypesAlt } from "../../../lib/api/ApiTypesAlt";
import { 
...
`determineAffectedWorkspaces(options: DetermineAffectedWorkspacesOptions): Promise<AffectedWorkspacesResult>`
...
`runAffectedWorkspaceScript(options: RunAffectedWorkspaceScriptOptions): Promise<RunScriptAcrossWorkspacesResult>`
...
You can read more about the verify feature [here](/concepts/verify).
