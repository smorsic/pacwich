...
const WELCOME = [
  ...
  "  \x1b[36mrun build\x1b[0m",
  "  \x1b[36mrun build --dep-order\x1b[0m",
  "  \x1b[36mlist-affected --files 'packages/**/*.ts'\x1b[0m",
  "  \x1b[36m--help\x1b[0m",
  "",
  "\x1b[2mScript output is mocked. There's no shell or git, so inline scripts,",
  "doctor, --cwd, and git-diff affected (--base/--head) aren't available —",
  "use --files for affected resolution.\x1b[0m",
  "",
];
