---
name: pacwich-api
description: "TypeScript API examples for createFileSystemProject and the Project/Workspace interfaces."
when_to_use: "When calling the pacwich TypeScript API (createFileSystemProject, Project/Workspace interfaces)."
---
...
See also: pacwich-overview, pacwich-concepts, pacwich-cli, pacwich-config.
