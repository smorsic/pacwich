---
name: pacwich-cli
description: "Full CLI command reference with examples, including run-script and all global options."
when_to_use: "When constructing or debugging pacwich CLI invocations."
---
...
# nearest ancestor package.json with a "workspaces" field):
...
See also: pacwich-overview, pacwich-concepts, pacwich-api, pacwich-config.
